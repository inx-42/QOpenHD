...
Item {
    ...
    Button{
        ...
        Text {
            ...
            verticalAlignment: Text.AlignVCenter
            color: mainStackLayout.currentIndex == m_selection_index ? "#33aaff" : "#BBBBBB"  // Light blue for selection, light gray otherwise
        }

        background: Rectangle {
            opacity: .8
            radius: 5
            // Dark background, lighter on hover
            color: genericButton.hovered ? "#444444" : "#333333"
        }
